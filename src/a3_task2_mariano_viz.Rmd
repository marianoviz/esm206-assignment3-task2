...
The name *Ki-Adi-Mundi* was separated taking into account the fist dash as *Ki* (name_1) and *Adi* (name_2). The last part (*Mundi*) was dropped.
...
storm_danger <- storms %>% 
  mutate(danger = case_when(status == "hurricane" ~ "high",
                            TRUE ~ "moderate")) #ALSO WORKED: status != "hurricane" ~ "moderate" 
